...
if(isset($_GET['id'])) {
    ...
    $statement = $conexion->prepare('INSERT INTO usuarios (usuario, password, tipo , nombre, apellido, email, telefono, experiencia, perfil) 
    VALUES (:usuario, :password, "editor" , :nombre, :apellido, :correo, :telefono, :experiencia, "default.jpg")');
    ...
    header('Location: aceptar_editores.php');
} else {
