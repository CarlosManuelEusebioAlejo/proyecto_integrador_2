        ...
        <article>
            ...
            <form class="formulario" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                ...
                <select name="tema" id="" class="boton">
                    <option value="Nutrición" <?php if ($posts['tema'] == "Salud") echo "selected"; ?>>Nutrición</option>
                    <option value="Salud" <?php if ($posts['tema'] == "Bienestar") echo "selected"; ?>>Salud</option>
                </select>
