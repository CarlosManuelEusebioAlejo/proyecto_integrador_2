...
<div class="container">
    ...
    <h2 class="text-center py-3"><b>Registro de usuario</b></h2>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        ...
        <div class="form-group">
            <label for="apellido" class="pt-2">Apellido:</label>
            <input type="text" class="form-control" id="apellido" name="apellido" required placeholder="Ingresa tu apellido">
        </div>
        <div class="form-group">
            <label for="Usuario" class="pt-2">Usuario: <i class="bi bi-question-circle hover:bg-blue-200 rounded-full" title="Este usuario se mostrará como autor en las publicaciones"></i></label>
            <input type="text" class="form-control" id="Usuario" name="Usuario" required placeholder="Ingresa tu nombre de usuario">
        </div>
        <div class="form-group">
            <label for="email" class="pt-2">Correo Electrónico: <i class="bi bi-question-circle hover:bg-blue-200 rounded-full" title="Este correo será parte del autor en las publicaciones"></i></label>
            <input type="email" class="form-control" id="email" name="email" required placeholder="Ej..[fitlife@gmail.com]">
        </div>

        <div class="form-group">
            <label for="number" class="pt-2">Número de teléfono</label>
        ...
        <div class="d-flex">
            <div class="form-group w-full mr-1">
                <label for="contrasena" class="pt-2">Contraseña: <i class="bi bi-question-circle hover:bg-blue-200 rounded-full" title="Esta contraseña será necesaria para iniciar sesión"></i></label>
            ...
            <div class="form-group w-full ml-1">
                <label for="confirmar" class="pt-2">Confirmar Contraseña: <i class="bi bi-question-circle hover:bg-blue-200 rounded-full" title="Esta contraseña será necesaria para iniciar sesión"></i></label>
                <input type="password" class="form-control" id="confirmar" name="confirmar" required placeholder="Confirma tu contraseña">
            </div>
        </div>
        <div class="form-group">
            <label for="experiencia" class="pt-2 ">Experiencia: <i class="bi bi-question-circle hover:bg-blue-200 rounded-full" title="Háblanos un poco más sobre ti"></i></label>
        ...
        <br>
        <button type="submit" class="btn btn-primary float-end" mt-2>Registrarse</button>
        <br><br>
    </form>
</div>
<div class="container">
    <footer class="py-5">
      <div class="mb-5">
        <div class="mb-3 py-4 my-4">
          <p class=>© 2024 blog Web, FITLIFE.</p>
        </div>
      </div>
    </footer>
  </div>
