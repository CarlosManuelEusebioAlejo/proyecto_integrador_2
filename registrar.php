...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if ($resultado['total'] > 0) {
        ...
        $statement = $conexion->prepare('INSERT INTO postulantes (usuario, nombre, apellido, correo, telefono, experiencia, password, status) VALUES (:usuario, :nombre, :apellido, :correo, :telefono, :experiencia, :password, "pendiente")');
